...
namespace ToDoList {
    ...
    public partial class PlannerDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TasksDataTable : global::System.Data.TypedTableBase<TasksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TasksRow AddTasksRow(string description, System.DateTime date) {
...
namespace ToDoList.PlannerDBDataSetTableAdapters {
    ...
    public partial class TasksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Tasks] WHERE (([id] = @Original_id) AND ([date] = @Original_da" +
                "te))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tasks] ([description], [date]) VALUES (@description, @date);\r\n" +
                "SELECT id, description, date FROM Tasks WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tasks] SET [description] = @description, [date] = @date WHERE (([id" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ToDoList.Properties.Settings.Default.PlannerDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, description, date FROM dbo.Tasks";
        ...
        public virtual int Fill(PlannerDBDataSet.TasksDataTable dataTable) {
        ...
        public virtual PlannerDBDataSet.TasksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PlannerDBDataSet.TasksDataTable dataTable = new PlannerDBDataSet.TasksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PlannerDBDataSet.TasksDataTable dataTable) {
